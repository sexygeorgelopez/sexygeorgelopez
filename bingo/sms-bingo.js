...
{ name: "Bianco 4 Entirely Fluddless", jp: "ビアンコ4ポンプ禁止", types: ["Bianco_20", "Bianco_Early", "Bianco_Shines"] }
];
bingoList[3] = [
...
{ name: "9 Shines from Delfino Plaza", jp: "ドルピックタウンのシャイン9枚", types: ["Plaza_M", "Plaza_Shines", "Shadow_Plaza", "Hidden_Plaza", "Plaza_Mix_Up"] },
...
{ name: "Defeat Shadow Mario in Ricco Harbor", jp: "リコハーバーのニセマリオ撃破", types: ["Ricco_Shadow", "Shadow_Mario", "Ricco_Late", "Ricco_Shines", "Ricco_8"] },
{ name: "Bianco Hills Episode 8 Shine", jp: "ビアンコヒルズストーリー8", types: ["Bianco_Shadow", "Bianco_Late", "Bianco_Yoshi", "Turbo_Nozzle", "Bianco_Shines", "Bianco_8"] }
];
bingoList[15] = [
...
bingoList[21] = [
{ name: "Defeat King Boo", jp: "Japanese Text", types: ["Sirena_5", "Sirena_Late", "Sirena_8", "Sirena_Boss"] },
...
{ name: "9 Shines from a single level (not plaza)", jp: "任意の1ステージからシャイン9枚取得（ドルピックタウン以外）", types: ["Ricco_8", "Sirena_8", "Bianco_8", "Gelato_8", "Pinna_8", "Pianta_8", "Red_Shines", "9_S", "Single_Mix_Up"] },
...
{ name: "10 Shines from a single level (not plaza)", jp: "任意の1ステージからシャイン10枚取得（ドルピックタウン以外）", types: ["Ricco_8", "Sirena_8", "Bianco_8", "Gelato_8", "Pinna_8", "Pianta_8", "Red_Shines", "9_S", "Single_Mix_Up"] },
{ name: "Collect 2 Hidden Shines in Pianta Village", jp: "モンテのむらの隠しシャイン2枚", types: ["Pianta_Late", "Pianta_Hidden", "Pianta_8", "Pianta_Shines", "9_S", "Low_Reds", "Pianta_Lives"] }
];
bingoList[23] = [
{ name: "Pinna Park Episode 8 Shine", jp: "ピンナパークストーリー8", types: ["Pinna_8", "Pinna_Late", "Pinna_Shines", "Gelato_8"] },
...
bingoList[24] = [
{ name: "Defeat Shadow Mario in Sirena Beach", jp: "シレナビーチのニセマリオ撃破", types: ["Shadow_Mario", "Sirena_Shadow", "Sirena_Late", "Rocket_Nozzle"] },
...
{ name: "4 Rocket Nozzle Unlocks", jp: "ロケットノズル4つ解放", types: ["Rocket_Nozzle", "Ricco_Rocket", "Bianco_Rocket", "Gelato_Rocket", "Noki_Rocket", "Four_Rockets"] },
{ name: "Sirena Beach Episode 8 Shine", jp: "シレナビーチストーリー8", types: ["Sirena_8", "Sirena_Late"] },
{ name: "Ride Yoshi in 3 Different Levels (not plaza)", jp: "Japanese Text", types: ["Pianta_6", "Pianta_Yoshi", "Butterfly", "X_Lives", "Plaza_Shines", "5_Bosses"] },
