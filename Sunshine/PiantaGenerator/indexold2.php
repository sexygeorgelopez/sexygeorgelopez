...
<p>Preview:</p>
        ...
        <img src="site3.php?id=<?php echo $_GET["choice"]; ?><?php echo $_GET["choice1"]; ?><?php echo $_GET["choice2"]; ?><?php echo $_GET["choice3"]; ?>" alt="Image created by a PHP script" width="178" height="182">
